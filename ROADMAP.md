# AICP v85 — Roadmap Items (repo-backed)
...
- **Step 2 evidence:** TB-HTTP-0.1 binding conformance suite + fixtures + report are now shipped, including ACK, cursor-expiry, minimal WS framing, WS pull-based backpressure/chunking evidence, reliability/duplication invariant checks, and a WS frame↔embedded mirror check.
- **Next concrete step:** SSE framing/backpressure guidance plus deeper anti-replay/idempotency hardening (M22 next).
