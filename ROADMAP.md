...
- **Progress:** public interoperability corpus packaging now defines example submission manifests, compatibility-claim evidence guidance, and lightweight validation for future external profile-based evidence packages without fabricating ecosystem results.
