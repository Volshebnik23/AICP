...
.PHONY: validate test conformance conformance-ext conformance-all lint release-check clean
...
clean:
	rm -f conformance/report.json conformance/report_ext_capneg.json conformance/report_ext_object_resync.json conformance/report_ext_policy_eval.json
