...
- **I want to validate compatibility with a profile** → [docs/architecture/AICP_Adoption_Core_and_Tiers.md](architecture/AICP_Adoption_Core_and_Tiers.md), [docs/interop/AICP_Compatibility_Claims_and_Evidence.md](interop/AICP_Compatibility_Claims_and_Evidence.md), [docs/profiles/AICP_Profiles.md](profiles/AICP_Profiles.md), [docs/profiles/Profile_Selection_Guide.md](profiles/Profile_Selection_Guide.md).
...
- Public interop corpus: [docs/interop/AICP_Public_Interop_Corpus.md](interop/AICP_Public_Interop_Corpus.md)
- Compatibility claims and evidence: [docs/interop/AICP_Compatibility_Claims_and_Evidence.md](interop/AICP_Compatibility_Claims_and_Evidence.md)
