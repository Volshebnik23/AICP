...
`AICP-EVIDENCE-TCK-1.4.0`. A complete external implementation may be eligible for
...
internal-only. Report 2.1 and current `AICP-EVIDENCE-TCK-1.4.0` provide the exact Mediated Blocking,
...
Evidence TCK 1.0.0, 1.2.0, and 1.3.0 are frozen, historical, and strong-ineligible for their
