...
- M28 (`RFC_EXT_IAM_BRIDGE.md`) is shipped with executable extension conformance coverage for OAuth/OIDC claim mapping to AICP-native delegation/approval controls.
