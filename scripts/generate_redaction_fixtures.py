...
def build_case(case_id: str, *, with_pii: bool = False, include_retention: bool = True, original_ref_mode: str = "valid", include_proof: bool = True, bad_pii: bool = False, retention_missing_audit: bool = False, retention_missing_policy_category: bool = False, retention_bad_policy_category: bool = False, retention_bad_delete_semantics: bool = False) -> list[dict]:
    ...
    if include_retention:
        ...
        if retention_bad_policy_category:
            rp["policy_category"] = "invalid_retention_class"
...
def main() -> int:
    fixtures = {
        ...
        "RD-08_missing_policy_category_expected_fail.jsonl": build_case("RD08", include_retention=True, retention_bad_policy_category=True),
