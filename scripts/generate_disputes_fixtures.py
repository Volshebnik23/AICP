...
def main() -> None:
    ...
    ds02 = finalize([
        ...
        {"session_id": "sDS2", "message_id": "m4", "timestamp": "2026-01-08T00:10:06Z", "sender": "auditor:Q", "message_type": "CHALLENGE_ASSERTION", "contract_id": "cDS2", "contract_ref": cref, "payload": {"challenge_id": "CH-2", "target_ref": {"message_id": "m3"}, "challenge_type": "UNKNOWN_TYPE", "claim": "Output diverges from expected evidence", "evidence_refs": ["urn:evidence:ds02:1"]}},
    ])
