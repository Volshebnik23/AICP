...
`AICP-EVIDENCE-TCK-1.4.0` provenance can be independently eligible for
...
historical 1.0.0, 1.2.0, and 1.3.0 reports are strong-ineligible for documented evidence
defects.
