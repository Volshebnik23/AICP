"""TCK 1.1 semantic normalization, including challenge-binding outcomes."""
        ...
        for item in messages:
            ...
            if message.get("message_type") == "CONTRACT_PROPOSE":
                ...
                shape = {
                    ...
                    "goal_is_runtime_challenge": contract.get("goal") == run.get("challenge"),
                }
            ...
            normalized_messages.append(
                {
                    ...
                    "control_is_run_bound": (
                        item.get("control_request", {}).get("input", {}).get("run_id") == run.get("run_id")
                        and item.get("control_request", {}).get("input", {}).get("challenge") == run.get("challenge")
                    ),
                }
            )
        directions.append(
