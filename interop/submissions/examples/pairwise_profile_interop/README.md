# Example only: pairwise profile interoperability claim

This package is a **fictional vocabulary and folder-shape example**. It does not represent a
...
Base/MCP side reports, and `AICP-PAIRWISE-TCK-1.3.0` joint report required for publication.
