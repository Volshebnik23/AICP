...
| Folder | Implementation | Artifact kind | Peer | Evidence status | Claim type | Claim scope | Profiles | Capabilities | Reported marks | Eligible profile marks | Eligible capability marks | Eligible targets | Matrix status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Folder | Implementation | Artifact kind | Evidence status | Claim type | Claim scope | Profiles | Capabilities | Reported marks | Eligible profile marks | Eligible capability marks | Eligible targets | Matrix status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
