...
from interop_submission_validation import load_schema_and_registry, validate_common_rules, validate_schema
...
def test_build_submission_tool_single_impl_package(tmp_path: Path) -> None:
...
def test_build_submission_tool_pairwise_package_validates(tmp_path: Path) -> None:
    report_one = _write_json(
